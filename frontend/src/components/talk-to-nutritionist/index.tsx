      ...
      <section className="w-full flex flex-col-reverse gap-7 lg:flex-row py-20 max-w-[1074px] mx-auto items-center justify-between">
        <div className="w-full flex flex-col gap-6 lg:max-w-[493px]">
          ...
          <p className="text-sm lg:text-base">
            Elevate your well-being with personalized nutrition guidance, chat with our top tier
            professional Nutritionists and embark on a journey to unleash your best self! whether
            you&apos;re seeking to manage your weight, boost your energy, or simply feel more
            vibrant, our team of experienced nutritionists is here to provide you with expert advice
            and support. Explore the power of nutrition in enhancing your health, and let us help
            you make informed choices that will leave you feeling your absolute best. Start your
            conversation with a nutritionist today and take that exciting step towards a healthier,
